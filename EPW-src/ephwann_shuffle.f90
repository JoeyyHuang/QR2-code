  ...
  USE epwcom,           ONLY : nbndsub, fsthick, epwread, system_2d, plrn,         &
                               ...
                               prtdipole, prtRaman ! Added for Raman calculations, by Jianqi Huang
  ...
  USE printing,         ONLY : print_gkk, plot_band, plot_fermisurface,            &
                               print_dipole, print_Raman ! Added for Raman calculations, by Jianqi Huang
    ...
    DO mesh_dum = 1, mesh_leng
      ...
      DO cycle_quad = 1, nc
        ...
        DO iqq = iq_restart, totq
          ...
          ENDIF
          !
          IF (prtdipole .AND. iq == 1) CALL print_dipole() ! Added for Raman calculations, by Jianqi Huang
          IF (prtRaman  ) CALL print_Raman(iq) ! Added for Raman calculations, by Jianqi Huang
