  ...
  USE epwcom,        ONLY : epexst, epbwrite, ep_coupling,                    &
                            ...
                            wfpt, compute_dmat, ahc_nbnd, ahc_nbndskip,       &
                            elecselfen_ahc, ahc_win_min, ahc_win_max, plrn,   &
                            ...
                            Elaser, Egamma, polar, filraman, ei, es, Cq, lBE, &
                            temphon, ltensor, qtensor_start, qtensor_end, prtdipole
  USE elph2,         ONLY : elph
  ...
  CALL mp_bcast(wfpt             , meta_ionode_id, world_comm)
  CALL mp_bcast(elecselfen_ahc   , meta_ionode_id, world_comm)
  ...
  ! Added for Raman calculations, by Jianqi Huang.
  CALL mp_bcast(prtRaman         , meta_ionode_id, world_comm)
  CALL mp_bcast(Raman_type       , meta_ionode_id, world_comm)
  CALL mp_bcast(lhoph            , meta_ionode_id, world_comm)
  CALL mp_bcast(reson_lim        , meta_ionode_id, world_comm)
  CALL mp_bcast(reson_thr        , meta_ionode_id, world_comm)
  CALL mp_bcast(Elaser           , meta_ionode_id, world_comm)
  CALL mp_bcast(Egamma           , meta_ionode_id, world_comm)
  CALL mp_bcast(polar            , meta_ionode_id, world_comm)
  CALL mp_bcast(filraman         , meta_ionode_id, world_comm)
  CALL mp_bcast(ei               , meta_ionode_id, world_comm)
  CALL mp_bcast(es               , meta_ionode_id, world_comm)
  CALL mp_bcast(Cq               , meta_ionode_id, world_comm)
  CALL mp_bcast(lBE              , meta_ionode_id, world_comm)
  CALL mp_bcast(temphon          , meta_ionode_id, world_comm)
  CALL mp_bcast(ltensor          , meta_ionode_id, world_comm)
  CALL mp_bcast(qtensor_start    , meta_ionode_id, world_comm)
  CALL mp_bcast(qtensor_end      , meta_ionode_id, world_comm)
  CALL mp_bcast(prtdipole        , meta_ionode_id, world_comm)
  !
#endif
  !
  !-----------------------------------------------------------------------
