        ...
        IF (mpime == ionode_id) THEN
          ...
          IF (TRIM(polar) == 'custom') THEN
            ...
            DO mu = 1, nmodes
              ...
              !
              WRITE(10, '(2x, i3, 2x, f10.4, 1x, 2(2x, es22.12e3))') mu, frq, Raman_p/nktotf**2, Raman_m/nktotf**2
              !
            ENDDO ! mu
            !
            CLOSE(10)
        ...
        IF (mpime == ionode_id) THEN
          ...
          IF (TRIM(polar) == 'custom') THEN
            ...
            DO mu = 1, nmodes
              ...
              !
              WRITE(10, '(2x, i3, 2x, f10.4, 3(1x, 2(2x, es22.12e3)))') mu, frq, Raman_p/nktotf**2, Raman_m/nktotf**2, &
                                   Raman_e_p/nktotf**2, Raman_e_m/nktotf**2, Raman_h_p/nktotf**2, Raman_h_m/nktotf**2
            ENDDO ! mu
            !
            CLOSE(10)
            !
          ...
          DO mu = 1, nmodes
            ...
            DO nu = 1, nmodes
              ...
              WRITE(10, '(2(2x, i3), 2(2x, f10.4), 1x, 4(2x, es22.12e3))') mu, nu, frq, frq2, &
                          Raman_pp/nktotf**2, Raman_mm/nktotf**2, Raman_pm/nktotf**2, Raman_mp/nktotf**2
              !
            ENDDO ! nu
          ENDDO ! mu
          !
          ...
          DO mu = 1, nmodes
            ...
            DO nu = 1, nmodes
              ...
              WRITE(10, '(2(2x, i3), 2(2x, f10.4), 5(1x,4(2x, es22.12e3)))') mu, nu, frq, frq2, &
                            Raman_pp/nktotf**2, Raman_mm/nktotf**2, Raman_pm/nktotf**2, Raman_mp/nktotf**2, &
                Raman_ee_pp/nktotf**2, Raman_ee_mm/nktotf**2, Raman_ee_pm/nktotf**2, Raman_ee_mp/nktotf**2, &
                Raman_hh_pp/nktotf**2, Raman_hh_mm/nktotf**2, Raman_hh_pm/nktotf**2, Raman_hh_mp/nktotf**2, &
                Raman_eh_pp/nktotf**2, Raman_eh_mm/nktotf**2, Raman_eh_pm/nktotf**2, Raman_eh_mp/nktotf**2, &
                Raman_he_pp/nktotf**2, Raman_he_mm/nktotf**2, Raman_he_pm/nktotf**2, Raman_he_mp/nktotf**2
            ENDDO ! nu
          ENDDO ! mu
          !
          CLOSE(10)
      ...
      IF (mpime == ionode_id) THEN
        ...
        IF (TRIM(polar) == 'custom') THEN
          ...
          DO mu = 1, nmodes
            ...
            !
            WRITE(10, '(2(2x, i3), 2x, f10.4, 1x, 2(2x, es22.12e3))') mu, 0, frq, Raman_p/nktotf**2, Raman_m/nktotf**2
          ENDDO ! mu
          ...
          DO mu = 1, nmodes
            ...
            IF (lBE) Raman_m = bewph_as(branch(mu)) * Raman_m
            !
            WRITE(10, '(2(2x, i3), 2x, f10.4, 1x, 2(2x, es22.12e3))') 0, mu, frq, Raman_p/nktotf**2, Raman_m/nktotf**2
          ENDDO ! mu
          !
          CLOSE(10)
          !
      ...
      IF (mpime == ionode_id) THEN
        ...
        IF (TRIM(polar) == 'custom') THEN
          ...
          DO mu = 1, nmodes
            ...
            !
            WRITE(10, '(2(2x, i3), 2x, f10.4, 5(1x,2(2x, es22.12e3)))') mu, 0, frq, Raman_p/nktotf**2, Raman_m/nktotf**2, &
                                  Raman_ee_p/nktotf**2, Raman_ee_m/nktotf**2, Raman_hh_p/nktotf**2, Raman_hh_m/nktotf**2, &
                                  Raman_eh_p/nktotf**2, Raman_eh_m/nktotf**2, Raman_he_p/nktotf**2, Raman_he_m/nktotf**2
          ENDDO ! mu
          !
          DO mu = 1, nmodes
            frq = wf(branch(mu), iq) * rydcm1
            ...
            IF (lBE) Raman_he_m = bewph_as(branch(mu)) * Raman_he_m
            !
            WRITE(10, '(2(2x, i3), 2x, f10.4, 5(1x,2(2x, es22.12e3)))') 0, mu, frq, Raman_p/nktotf**2, Raman_m/nktotf**2, &
                                  Raman_ee_p/nktotf**2, Raman_ee_m/nktotf**2, Raman_hh_p/nktotf**2, Raman_hh_m/nktotf**2, &
                                  Raman_eh_p/nktotf**2, Raman_eh_m/nktotf**2, Raman_he_p/nktotf**2, Raman_he_m/nktotf**2
          ENDDO ! mu
          !
